...
import StateZonalOfficeProfilePage from "./stateOffice/StateZonalOfficeProfilePage";
import StateZonalFocalPersonsPage from "./stateOffice/StateZonalFocalPersonsPage";
      ...
      <SidebarInset className="flex flex-col overflow-hidden bg-[#f4f7f5]">
        ...
        <main className="flex-1 overflow-y-auto scrollbar-thin">
          ...
          <Routes>
            ...
            <Route path="/soc/ict-support-register" element={<StateOfficeReportsList key="state-ict-support-register" reportType="ict-support-register" onBack={() => setView("home")} defaultZoneId={user?.zone_id ? String(user.zone_id) : monthlyCtx.defaultZoneId} defaultStateId={user?.state_id ? String(user.state_id) : monthlyCtx.defaultStateId} />} />
            <Route path="/soc/adhoc-special-assignment" element={<StateOfficeReportsList key="state-adhoc-special-assignment" reportType="adhoc-special-assignment" onBack={() => setView("home")} defaultZoneId={user?.zone_id ? String(user.zone_id) : monthlyCtx.defaultZoneId} defaultStateId={user?.state_id ? String(user.state_id) : monthlyCtx.defaultStateId} />} />
